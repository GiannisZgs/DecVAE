...
"""Calculate latent disentanglement matrices for VAE models. This script loads pretrained VAE models from specified checkpoints,
or initializes random VAE models or ICA/PCA/kPCA models, and computes disentanglement matrices based on the whole dataset or a subset of it. 
...
JSON_FILE_NAME_MANUAL = "config_files/VAEs/timit/latent_evaluations/config_vae1d_latent_anal_voc_als.json" #for debugging purposes only
SAVE_DIR = '../latent_disentanglement_matrices_vaes/voc_als_ica'
...
def main():
    ...
    for ckp in data_training_args.epoch_range_to_evaluate:
        ...
        if data_training_args.dataset_name in ["VOC_ALS", "iemocap"]:
            ...
            mu_X_z = torch.cat((z_mean, z_mean_test), dim=0)
        ...
        latent_vis_dict_z["X"] = compute_disentanglement_matrices(mu_X_z, factor_dict, store_dir, "X", compute_3d_slices = True, save_visualizations=False)
