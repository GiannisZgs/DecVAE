...
from data_collation import DataCollatorForVAE1D_SSL_FineTuning_NoFeatureExtraction
...
def main():
    ...
    data_collator = DataCollatorForVAE1D_SSL_FineTuning_NoFeatureExtraction(
        model=model,
