...
features = ["mel","detected_frequencies","vowels","consonants","gender","speaker_id","overlap_mask"]
data = load_json_files(directory,features)

with open(os.path.join(directory,f'dec_quality_{LEVEL}_NoC{NOC}_{DECOMP}_mel_quarter.json'), 'w') as f:
    json.dump(data, f)