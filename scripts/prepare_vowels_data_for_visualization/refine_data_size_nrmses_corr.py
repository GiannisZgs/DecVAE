...
features = ["NRMSEs","correlograms","vowels","consonants","gender","speaker_id","overlap_mask"]
data = load_json_files(directory,features)

with open(os.path.join(directory,f'dec_quality_{LEVEL}_NoC{NOC}_{DECOMP}_NRMSEs_correlograms.json'), 'w') as f:
    json.dump(data, f)