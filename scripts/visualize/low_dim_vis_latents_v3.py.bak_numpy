...
from latent_analysis_utils import visualize, set_vis_flags, manifold, plot_manifold_latents, plot_aggregations
import warnings
import time
        ...
        def sim_vowels_latent_vis(config,data_training_args,decomp_args,data_subset,vis_that_subset,
            ...
            if vis_that_subset and vis_args.visualize_latent_frame and (config.dual_branched_latent or config.only_z_branch):
                ...
                if "vowel" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=vowel_labels, target='vowel', group='vowels',
                ...
                if "speaker_id" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=speaker_labels_frame, target='speaker_frame', group='speakers',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
            ...
            if vis_that_subset and vis_args.visualize_latent_sequence and (config.dual_branched_latent or config.only_s_branch):
                ...
                plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                    strategies=vis_args.aggregation_strategies_to_plot_seq,
                    sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                    y_vec=speaker_labels_seq, target='speaker_seq', group='speakers_seq',
                    data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                    manifold_dict=manifold_dict, project_guarded=False)
        ...
        def timit_latent_vis(config,data_training_args,decomp_args,data_subset,vis_that_subset,
            ...
            if vis_that_subset and vis_args.visualize_latent_frame and (config.dual_branched_latent or config.only_z_branch):
                ...
                if "phoneme" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z_sel_phonemes, mu_components_z_sel_phonemes), 'OCs_joint': (mu_OCs_joint_frame_reduced_sel_phonemes, None), 'OCs_proj': (mu_projections_z_sel_phonemes, None), 'all': (mu_all_frame_reduced_sel_phonemes, None)},
                        y_vec=sel_phonemes, target='phoneme39', group='phonemes',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "consonant" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z_sel_consonants, mu_components_z_sel_consonants), 'OCs_joint': (mu_OCs_joint_frame_reduced_sel_consonants, None), 'OCs_proj': (mu_projections_z_sel_consonants, None), 'all': (mu_all_frame_reduced_sel_consonants, None)},
                        y_vec=sel_consonants, target='consonant', group='consonants',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "vowel" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z_sel_vowels, mu_components_z_sel_vowels), 'OCs_joint': (mu_OCs_joint_frame_reduced_sel_vowels, None), 'OCs_proj': (mu_projections_z_sel_vowels, None), 'all': (mu_all_frame_reduced_sel_vowels, None)},
                        y_vec=sel_vowels, target='vowel', group='vowels',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "speaker_id" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z_sel_speakers, mu_components_z_sel_speakers), 'OCs_joint': (mu_OCs_joint_frame_reduced_sel_speakers, None), 'OCs_proj': (mu_projections_z_sel_speakers, None), 'all': (mu_all_frame_reduced_sel_speakers, None)},
                        y_vec=sel_10_speakers, target='speaker_frame', group='speakers',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                    ...
                    if vis_args.plot_3d:
                        ...
                        plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                            strategies=vis_args.aggregation_strategies_to_plot_frame,
                            sources={'X_OCs_freq': (mu_originals_z, mu_components_z_sel_speakers), 'OCs_joint': (mu_OCs_joint_frame_reduced_sel_speakers, None), 'OCs_proj': (mu_projections_z_sel_speakers, None), 'all': (mu_all_frame_reduced_sel_speakers, None)},
                            y_vec=sel_10_speakers, target='speaker_frame', group='speakers',
                            data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                            manifold_dict=manifold_dict)
            ...
            if vis_that_subset and vis_args.visualize_latent_sequence and (config.dual_branched_latent or config.only_s_branch):
                ...
                plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                    strategies=vis_args.aggregation_strategies_to_plot_seq,
                    sources={'X_OCs_freq': (mu_originals_s_sel_speakers, mu_components_s_sel_speakers), 'OCs_joint': (mu_OCs_joint_seq_reduced_sel_speakers, None), 'OCs_proj': (mu_projections_s_sel_speakers, None), 'all': (mu_all_seq_reduced_sel_speakers, None)},
                    y_vec=sel_10_speakers_seq, target='speaker_seq', group='speakers_seq',
                    data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                    manifold_dict=manifold_dict, project_guarded=False)
            ...
            if vis_that_subset and vis_args.visualize_latent_frame and (config.dual_branched_latent or config.only_z_branch):
                ...
                if "phoneme" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z_sel_phonemes, mu_components_z_sel_phonemes), 'OCs_joint': (mu_OCs_joint_frame_reduced_sel_phonemes, None), 'OCs_proj': (mu_projections_z_sel_phonemes, None), 'all': (mu_all_frame_reduced_sel_phonemes, None)},
                        y_vec=sel_phonemes, target='phoneme', group='phonemes',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "non_verbal_phoneme" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z_sel_non_verbal_phonemes, mu_components_z_sel_non_verbal_phonemes), 'OCs_joint': (mu_OCs_joint_frame_reduced_sel_non_verbal_phonemes, None), 'OCs_proj': (mu_projections_z_sel_non_verbal_phonemes, None), 'all': (mu_all_frame_reduced_sel_non_verbal_phonemes, None)},
                        y_vec=sel_non_verbal_phonemes, target='non_verbal_phoneme', group='non_verbal_phonemes',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "emotion" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=emotion_labels_frame, target='emotion_frame', group='categorical_emotions',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
            ...
            if vis_that_subset and vis_args.visualize_latent_sequence and (config.dual_branched_latent or config.only_s_branch):
                ...
                if "emotion" in vis_args.variables_to_plot_latent_seq:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_seq,
                        sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                        y_vec=emotion_labels_seq, target='emotion_seq', group='emotion_seq',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                        manifold_dict=manifold_dict, project_guarded=False)
            ...
            if vis_that_subset and vis_args.visualize_latent_frame and (config.dual_branched_latent or config.only_z_branch):
                ...
                if "phoneme" in vis_args.variables_to_plot_latent:
                    ...
                    if vis_args.plot_3d:
                        ...
                        plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                            strategies=vis_args.aggregation_strategies_to_plot_frame,
                            sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                            y_vec=phoneme_labels, target='phoneme', group='phonemes',
                            data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                            manifold_dict=manifold_dict)
                ...
                if "alsfrs_total" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=alsfrs_total, target='alsfrs_total', group='alsfrs_total',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "alsfrs_speech" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=alsfrs_speech, target='alsfrs_speech', group='alsfrs_speech',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "disease_duration" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=disease_duration, target='disease_duration', group='disease_duration',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "king_stage" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=king_stage, target='king_stage', group='king_stage',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "group" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=group, target='group', group='group',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
                ...
                if "cantagallo" in vis_args.variables_to_plot_latent:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_frame,
                        sources={'X_OCs_freq': (mu_originals_z, mu_components_z), 'OCs_joint': (mu_OCs_joint_frame_reduced, None), 'OCs_proj': (mu_projections_z, None), 'all': (mu_all_frame_reduced, None)},
                        y_vec=cantagallo, target='cantagallo', group='cantagallo',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict)
            ...
            if vis_that_subset and vis_args.visualize_latent_sequence and (config.dual_branched_latent or config.only_s_branch):
                ...
                if "phoneme" in vis_args.variables_to_plot_latent_seq:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_seq,
                        sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                        y_vec=phoneme_labels_seq, target='phoneme_seq', group='phoneme_seq',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                        manifold_dict=manifold_dict, project_guarded=False)
                ...
                if "alsfrs_total" in vis_args.variables_to_plot_latent_seq:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_seq,
                        sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                        y_vec=alsfrs_total_seq, target='alsfrs_total_seq', group='alsfrs_total_seq',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                        manifold_dict=manifold_dict, project_guarded=False)
                ...
                if "alsfrs_speech" in vis_args.variables_to_plot_latent_seq:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_seq,
                        sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                        y_vec=alsfrs_speech_seq, target='alsfrs_speech_seq', group='alsfrs_speech_seq',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                        manifold_dict=manifold_dict, project_guarded=False)
                ...
                if "disease_duration" in vis_args.variables_to_plot_latent_seq:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_seq,
                        sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                        y_vec=disease_duration_seq, target='disease_duration_seq', group='disease_duration_seq',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                        manifold_dict=manifold_dict, project_guarded=False)
                ...
                if "king_stage" in vis_args.variables_to_plot_latent_seq:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_seq,
                        sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                        y_vec=king_stage_seq, target='king_stage_seq', group='king_stage_seq',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                        manifold_dict=manifold_dict, project_guarded=False)
                ...
                if "group" in vis_args.variables_to_plot_latent_seq:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_seq,
                        sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                        y_vec=group_seq, target='group_seq', group='group_seq',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                        manifold_dict=manifold_dict, project_guarded=False)
                ...
                if "cantagallo" in vis_args.variables_to_plot_latent_seq:
                    ...
                    plot_aggregations(data_training_args, vis_args, decomp_args.decomp_to_perform, BETAS, data_subset, config,
                        strategies=vis_args.aggregation_strategies_to_plot_seq,
                        sources={'X_OCs_freq': (mu_originals_s, mu_components_s), 'OCs_joint': (mu_OCs_joint_seq_reduced, None), 'OCs_proj': (mu_projections_s, None), 'all': (mu_all_seq_reduced, None)},
                        y_vec=cantagallo_seq, target='cantagallo_seq', group='cantagallo_seq',
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_seq_to_vis) + '_seqs',
                        manifold_dict=manifold_dict, project_guarded=False)
