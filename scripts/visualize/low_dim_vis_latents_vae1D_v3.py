        ...
        def sim_vowels_latent_vis(config,data_training_args,decomp_args,data_subset,vis_that_subset,
            ...
            if vis_that_subset and vis_args.visualize_latent_frame:
                ...
                if "vowel" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=vowel_labels, target="vowel",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='vowels')
                ...
                if "speaker_id" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=speaker_labels_frame, target="speaker_frame",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='speakers')
        ...
        def timit_latent_vis(config,data_training_args,decomp_args,data_subset,vis_that_subset,
            ...
            if vis_that_subset and vis_args.visualize_latent_frame:
                ...
                if "phoneme" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z_sel_phonemes, OCs=None, y_vec=sel_phonemes, target="phoneme39",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='phonemes')
                ...
                if "vowel" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z_sel_vowels, OCs=None, y_vec=sel_vowels, target="vowel",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='vowel')
                ...
                if "consonant" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z_sel_consonants, OCs=None, y_vec=sel_consonants, target="consonant",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='consonant')
                    ...
                    if vis_args.use_umap:
                        ...
                        if vis_args.plot_3d:
                            ...
                            plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                                X=mu_originals_z_sel_consonants, OCs=None, y_vec=sel_consonants,
                                target="consonant",
                                data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                                manifold_dict=manifold_dict, embedding='X', group='consonant')
                ...
                if "speaker_id" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z_sel_speakers, OCs=None, y_vec=sel_10_speakers, target="speaker_frame",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='speakers')
                    ...
                    if vis_args.use_umap:
                        ...
                        if vis_args.plot_3d:
                            ...
                            plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                                X=mu_originals_z_sel_speakers, OCs=None, y_vec=sel_10_speakers,
        ...
        def iemocap_latent_vis(config,data_training_args,decomp_args,data_subset,vis_that_subset,
            ...
            if vis_that_subset and vis_args.visualize_latent_frame:
                ...
                if "phoneme" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z_sel_phonemes, OCs=None, y_vec=sel_phonemes, target="phoneme",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='phonemes')
                ...
                if "non_verbal_phoneme" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z_sel_non_verbal_phonemes, OCs=None, y_vec=sel_non_verbal_phonemes,
                        target="non_verbal_phoneme",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='non_verbal_phonemes')
                ...
                if "emotion" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=emotion_labels_frame, target="emotion",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='categorical_emotions')
        ...
        def voc_als_latent_vis(config,data_training_args,decomp_args,data_subset,vis_that_subset,
            ...
            if vis_that_subset and vis_args.visualize_latent_frame:
                ...
                if "phoneme" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=phoneme_labels, target="phoneme",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='phoneme')
                ...
                if "alsfrs_total" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=alsfrs_total, target="alsfrs_total",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='alsfrs_total')
                ...
                if "alsfrs_speech" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=alsfrs_speech, target="alsfrs_speech",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='alsfrs_speech')
                ...
                if "disease_duration" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=disease_duration, target="disease_duration",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='disease_duration')
                ...
                if "king_stage" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=king_stage, target="king_stage",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='king_stage')
                ...
                if "group" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=group, target="group",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='group')
                ...
                if "group" in vis_args.variables_to_plot_latent:
                    ...
                    plot_manifold_latents(data_training_args, vis_args, model_args.vae_type + '_' + model_args.vae_input_type, BETAS, data_subset, config,
                        X=mu_originals_z, OCs=None, y_vec=cantagallo, target="cantagallo",
                        data_set=data_training_args.dataset_name + '_' + data_subset + '_' + str(vis_args.latent_train_set_frames_to_vis) + '_frames',
                        manifold_dict=manifold_dict, embedding='X', group='cantagallo')
