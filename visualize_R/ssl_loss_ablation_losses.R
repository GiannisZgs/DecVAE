...
save_path1 <- file.path(save_dir, "ssl_loss_positive_divergence_Z_FD_betas_1.png")
save_path2 <- file.path(save_dir, "ssl_loss_positive_divergence_S_FD_betas_1.png")
save_path3 <- file.path(save_dir, "ssl_loss_positive_cross_entropies_Z_FD_betas_1.png")
save_path4 <- file.path(save_dir, "ssl_loss_positive_cross_entropies_S_FD_betas_1.png")
save_path5 <- file.path(save_dir, "ssl_loss_negative_divergence_Z_FD_betas_1.png")
save_path6 <- file.path(save_dir, "ssl_loss_negative_divergence_S_FD_betas1.png")
save_path7 <- file.path(save_dir, "ssl_loss_negative_cross_entropies_Z_FD_betas_1.png")
save_path8 <- file.path(save_dir, "ssl_loss_negative_cross_entropies_S_FD_betas_1.png")
save_path9 <- file.path(save_dir, "ssl_loss_decomposition_FD_betas_Z_1.png")
save_path10 <- file.path(save_dir, "ssl_loss_decomposition_FD_betas_S_1.png")
