#' Fig.4: This script generates figures 4g in the main paper,
#' and supplementary figures 7c in the supplementary material. Creates metric scatterplots 
#' for the VOC-ALS dataset
...
parent_save_dir <-  file.path('..','figures','fig_4_voc_als_results','fig_4g_voc_als_metrics_scatter')
