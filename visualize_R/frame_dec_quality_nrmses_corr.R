...
nrmse_violins_save_dir <- file.path('..','figures','NRMSE_violins',level,decomposition, paste0("NoC",  NoC))
corr_save_dir <- file.path('..','figures','correlograms', decomposition, level, paste0("NoC",  NoC))
