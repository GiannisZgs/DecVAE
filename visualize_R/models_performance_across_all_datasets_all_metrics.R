...
selected_models_vowels <- c("PCA", "ICA", 
                     "AE", "VAE", "betaVAE", "DecAE_EWT", "DecAE_FD", 
                     "DecVAE_FD", "DecVAE_EWT", "betaDecVAE_FD", "betaDecVAE_EWT")
...
selected_models_timit <- c("PCA", "ICA", "raw_mels",
...
selected_models_voc_als <- c("raw_mels",
...
#"PCA",
selected_models_iemocap <- c("VAE_vowels", "VAE_timit", "betaVAE_vowels", "betaVAE_timit",
                     "DecVAE_FD_vowels", "DecVAE_EWT_vowels", "DecVAE_FD_timit","DecVAE_EWT_timit",
                     "betaDecVAE_FD_vowels", "betaDecVAE_EWT_vowels", "betaDecVAE_FD_timit","betaDecVAE_EWT_timit")
