#' SI Figure 25: Post-training ablation on the effect of the percentage of 
#' frames used in the SSL contrastive decomposition loss in the SimVowels dataset.
#' Values of percentages range from 10% to 90% and are displayed for several disentanglement
...
# Save data at
parent_save_dir <- file.path('..','supplementary_figures','SI_fig_25_vowels_post-training_ssl_percentage_ablation')
