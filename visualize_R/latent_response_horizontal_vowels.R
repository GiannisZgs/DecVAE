...
experiment <- 'fixed_vowels_5' #fixed_vowels_5, fixed_speakers_free_vowels_5
model <- 'vmd' #'vae1D_FC_mel'
beta <- '1'
...
parent_load_dir <- file.path('D:','latent_traversal_data','vowels')
if (grepl("vae",model)) {
...
#data_dir <- file.path(load_dir, experiment, model, paste0('b', beta), ckp ,paste0(latent,'_varying_',varying,'.json'))
#not used 
