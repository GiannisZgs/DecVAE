#' Fig.3: This script generates figures 2g,h in the main paper,
#' and supplementary figures 7a in the supplementary material. Creates metric scatterplots 
#' for the SimVowels dataset
...
parent_save_dir <-  file.path('..','figures','fig_2_vowels_results','fig_2g_vowels_metrics_scatter')
