...
#' The current script generates figures SI_fig24e,f showing the effect of
#' different percentages in the frames used for the SSL contrastive decomposition loss,
#' in the pre-training loss (cross-entropies).
