...
#' The current script generates figures SI_fig24c,d showing the effect of
#' different number of components in the SSL contrastive decomposition loss.
...
selected_betas <- c(1) # can be one or more values
...
save_path1 <- file.path(save_dir, "number_of_components_decomposition_loss_Z_FD_beta_1.png")
save_path2 <- file.path(save_dir, "number_of_components_decomposition_loss_S_FD_beta_1.png")
save_path3 <- file.path(save_dir, "number_of_components_divergence_positive_Z_FD_beta_1.png")
save_path4 <- file.path(save_dir, "number_of_components_divergence_positive_S_FD_beta_1.png")
save_path5 <- file.path(save_dir, "number_of_components_cross_entropy_positive_Z_FD_beta_1.png")
save_path6 <- file.path(save_dir, "number_of_components_cross_entropy_negative_Z_FD_beta_1.png")
save_path7 <- file.path(save_dir, "number_of_components_cross_entropy_negative_S_FD_beta_1.png")
save_path8 <- file.path(save_dir, "number_of_components_cross_entropy_positive_S_FD_beta_1.png")
save_path9 <- file.path(save_dir, "number_of_components_divergence_negative_Z_FD_beta_1.png")
save_path10 <- file.path(save_dir, "number_of_components_divergence_negative_S_FD_beta_1.png")
...
plot1_z_decomposition_loss <- create_line_chart_multi(
...
plot2_s_decomposition_loss <- create_line_chart_multi(
...
plot7_s_positive_cross_entropy <- create_line_chart_multi(
    data_paths = csv_file_path7,  # S-branch positive cross-entropy
    title = NULL,
    legend_title = "Components",
    x_col = "Epoch",
    x_label = "Epoch", 
...
plot8_s_negative_cross_entropy <- create_line_chart_multi(
    data_paths = csv_file_path8,  # S-branch negative cross-entropy
    title = NULL,
    legend_title = "Components",
    x_col = "Epoch",
    x_label = "Epoch", 
...
# Plot 9: Z-branch negative Divergences
plot9_z_negative_divergence <- create_line_chart_multi(
...
# Plot 4: S-branch negative Divergences
plot10_s_negative_divergence <- create_line_chart_multi(
