#' SI Figure 23: pre-training phase ablations for the SimVowels dataset.
#' The current script generates figures SI_fig23a,b showing the effect of
#' different percentages of frames used in the SSL contrastive decomposition loss.
...
# Save data at
parent_save_dir <- file.path('..','supplementary_figures','SI_fig_23_noc_ssl_ablations_pre-training_vowels')
save_dir <- file.path(parent_save_dir, current_script_experiment, model_type, set)
if (!dir.exists(save_dir)) {
  dir.create(save_dir, recursive = TRUE, showWarnings = FALSE)
}

save_path1 <- file.path(save_dir, "ssl_loss_positive_divergence_Z_FD_betas.png")
save_path2 <- file.path(save_dir, "ssl_loss_positive_divergence_S_FD_betas.png")
save_path3 <- file.path(save_dir, "ssl_loss_positive_cross_entropies_Z_FD_betas.png")
save_path4 <- file.path(save_dir, "ssl_loss_positive_cross_entropies_S_FD_betas.png")
save_path5 <- file.path(save_dir, "ssl_loss_negative_divergence_Z_FD_betas.png")
save_path6 <- file.path(save_dir, "ssl_loss_negative_divergence_S_FD_betas.png")
save_path7 <- file.path(save_dir, "ssl_loss_negative_cross_entropies_Z_FD_betas.png")
save_path8 <- file.path(save_dir, "ssl_loss_negative_cross_entropies_S_FD_betas.png")
save_path9 <- file.path(save_dir, "ssl_loss_decomposition_FD_betas_Z.png")
save_path10 <- file.path(save_dir, "ssl_loss_decomposition_FD_betas_S.png")
...
# Plot 1: Z-branch Divergences (negative)
