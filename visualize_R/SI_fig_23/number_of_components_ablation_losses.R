...
#' The current script generates figures SI_fig23c,d showing the effect of
#' different numbers of components used in the SSL contrastive decomposition loss (divergences).
...
selected_betas <- c(1) # set one value
...
save_path1 <- file.path(save_dir, paste0("number_of_components_divergences_Z_FD_beta_" ,selected_betas ,".png"))
save_path2 <- file.path(save_dir, paste0("number_of_components_divergences_S_FD_beta_" ,selected_betas ,".png"))
save_path3 <- file.path(save_dir, paste0("number_of_components_cross_entropies_Z_FD_beta_" ,selected_betas ,".png"))
save_path4 <- file.path(save_dir, paste0("number_of_components_cross_entropies_S_FD_beta_" ,selected_betas ,".png"))
save_path5 <- file.path(save_dir, paste0("number_of_components_decomposition_FD_beta_" ,selected_betas ,".png"))
