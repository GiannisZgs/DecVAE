#' Fig.3: This script generates figure 3h in the main paper containing an overview of the main
#' results for the TIMIT dataset.
...
# Save data at
parent_save_dir <- file.path('..','figures','fig_3_timit_results','fig_3h_timit_total_results_barchart')
