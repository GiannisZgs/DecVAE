#' SI Figure 26: Latent Subspace Aggregation Function Ablation
#' This script generates bar charts comparing various metrics 
#' across different latent space aggregation options for the SimVowels dataset.
...
# Save data at
parent_save_dir <- file.path('..','supplementary_figures','SI_fig_26_latent_aggregation_function_ablation')
