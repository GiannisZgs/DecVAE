#' SI Figure 14b: post-training evaluation on TIMIT. Ablation of the percentage
#' of frames used in the SSL contrastive decomposition loss w.r.t. disentanglement metrics.
