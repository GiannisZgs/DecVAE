...
#' The current script generates figures in SI_fig22a, which are a demonstration of
#' the different parts that compose the total optimization objective of DecVAE for the 
#' Z (frame variable) latent branch.
...
loss_file2_1 <- paste0(set, "_divergence_negative_Z.csv")
loss_file2_2 <- paste0(set, "_divergence_positive_Z.csv")
loss_file3_1 <- paste0(set, "_cross_entropy_negative_Z.csv")
loss_file3_2 <- paste0(set, "_cross_entropy_positive_Z.csv")
loss_file4 <- paste0(set, "_decomposition_loss_Z.csv")


loss_file5 <- paste0(set, "_prior_loss_Z.csv")
...
loss_file7_1 <- paste0('EWT_',loss_file2_1)
loss_file7_2 <- paste0('EWT_',loss_file2_2)
loss_file7_3 <- paste0('EWT_',set, "_divergence_negative_S.csv")
loss_file7_4 <- paste0('EWT_',set, "_divergence_positive_S.csv")
loss_file7_5 <- paste0('EWT_',loss_file2_1)
loss_file7_6 <- paste0('EWT_',loss_file2_2)
loss_file7_7 <- loss_file7_3
loss_file7_8 <- loss_file7_4
...
csv_file_path7_1 <- file.path(parent_load_dir, current_script_experiment, model_type, loss_file7_1)
csv_file_path7_2 <- file.path(parent_load_dir, current_script_experiment, model_type, loss_file7_2)
csv_file_path7_3 <- file.path(parent_load_dir, current_script_experiment, model_type, loss_file7_3)
csv_file_path7_4 <- file.path(parent_load_dir, current_script_experiment, model_type, loss_file7_4)
model_type <- "Z_only"
csv_file_path7_5 <- file.path(parent_load_dir, current_script_experiment, model_type, loss_file7_5)
csv_file_path7_6 <- file.path(parent_load_dir, current_script_experiment, model_type, loss_file7_6)
model_type <- "S_only"
csv_file_path7_7 <- file.path(parent_load_dir, current_script_experiment, model_type, loss_file7_7)
csv_file_path7_8 <- file.path(parent_load_dir, current_script_experiment, model_type, loss_file7_8)


save_path1 <- file.path(save_dir, "component_divergences_Z_FD_betas_0_1_10.png")
save_path2 <- file.path(save_dir, "component_aggregated_divergences_Z_FD_betas_0_1_10.png")
save_path3 <- file.path(save_dir, "component_cross_entropies_Z_FD_betas_0_1_10.png")
save_path4 <- file.path(save_dir, "decomposition_loss_Z_betas.png")
save_path5 <- file.path(save_dir2, "prior_loss_Z_betas.png")
save_path_panel <- file.path(save_dir, "Z_branch_losses_panel_figure.png")
save_path7 <- file.path(save_dir, "EWT_branch_divergences_comparison_betas_0_1_10.png")
...
current_focus <- "branch_comparison"

plot7 <- create_line_chart_multi(
    data_paths = c(csv_file_path7_1, csv_file_path7_2, csv_file_path7_3, csv_file_path7_4,
                   csv_file_path7_5, csv_file_path7_6, csv_file_path7_7, csv_file_path7_8),
    title = "", #Branch Divergence Comparison Across Model Types
    legend_title = "Model & Branch",
    x_col = "Epoch", 
    x_label = "Epoch",
    y_label = "Jensen-Shannon Divergence",
    y_limits = c(0, 1),
