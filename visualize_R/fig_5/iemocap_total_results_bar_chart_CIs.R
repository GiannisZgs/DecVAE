#' Fig.5: This script generates figure 5h in the main paper containing an overview of the main
#' results for the IEMOCAP dataset.
...
# Save data at
parent_save_dir <- file.path('..','figures','fig_5_iemocap_results', 'fig_5h_iemocap_post-training')
