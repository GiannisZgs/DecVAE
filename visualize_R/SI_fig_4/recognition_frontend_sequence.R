#' SI Figure 4: this script generates figure SI_fig_4d. Demonstrates the recovered 
#' simulated signals of the SimVowels dataset - the recognition model of the sequence variable.
...
save_dir <-  file.path('..','supplementary_figures','SI_fig_4','recognition_model','sequence')
