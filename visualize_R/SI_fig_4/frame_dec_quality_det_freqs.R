#' SI Figure 4: this script generates figures SI_fig_4_e,f,g,h. Demonstrates the efficiency
#' of the decomposition models as a recognition front-end before the DecVAE, and compares
#' the simulated data (SimVowels) frequency properties to real speech (TIMIT).
...
parent_save_dir <-  file.path('..','supplementary_figures','SI_fig_4','decomposition_quality_det_freqs')
