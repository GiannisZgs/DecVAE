"""
Data collators for visualizing input data to all models.
...
from args_configs.data_training_args import DataTrainingArguments
...
@dataclass
class DataCollatorForInputVisualization:
    """
    Data collator that handles batching for input visualization where no model is used. The model's utilities and configurations are still
    used for padding, feature extraction and batching in order to reproduce the input that a DecVAE or VAE model would receive.
